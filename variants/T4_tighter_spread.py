...
# T4 variant: tighter spread + larger base size (ericcccsliu P2 approach)
TOMATOES_DEFAULT_EDGE = 1      # was 2 — tighter to capture more volume
TOMATOES_SOFT_LIMIT = 15
TOMATOES_HARD_LIMIT = 40
TOMATOES_BASE_SIZE = 15        # was 12 — bigger to compensate tighter edge
...
class Trader:
    ...
    def trade_tomatoes(self, state: TradingState, trader_data: dict):
        ...
        if trending_down:
            ...
            sell_size = min(30, sell_size + 3)
        elif trending_up:
            sell_size = max(2, sell_size // 2)
            buy_size = min(30, buy_size + 3)
