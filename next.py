...
class Trader:
    ...
    def trade_tomatoes(self, state: TradingState, trader_data: dict):
        ...
        # Max-volume mid: anchor fair value to prices with the deepest resting volume.
        # More stable than best-bid/ask mid -- reflects where market makers are actually parked.
        ...
        # Fair value: use max-volume mid directly (EMA still used for trend detection)
        fair = round(mid)
